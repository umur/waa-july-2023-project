    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable).cors().and()
                .exceptionHandling((exceptionHandling) -> exceptionHandling
                        .authenticationEntryPoint(new AlumniAuthenticationEntryPoint()))
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/user/**").hasAnyAuthority("ADMIN", "FACULTY", "STUDENT")
                        // .requestMatchers("/faculties/**").permitAll()
                        .requestMatchers("/student/**")
                        .hasAnyAuthority("ADMIN", "FACULTY", "STUDENT")
                        .requestMatchers("/job-ads/**")
                         ...
                         * .requestMatchers("/student/**").hasAnyAuthority("ADMIN", "FACULTY",
                         * "STUDENT")
